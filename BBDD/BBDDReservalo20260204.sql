...
INSERT INTO `instalaciones` (`id_instalacion`, `nombre`, `descripcion`, `categoria_principal`, `categoria_opcional1`, `precio_completo`, `puede_completo`, `no_pistas`, `capacidad_completo`, `estado`, `material`, `iluminacion`, `tipo_reserva`, `direccion`) VALUES
	...
	(51, 'Silo', 'Instalación en la que se puede celebrar todo tipo de festejos como cumpleaños, reuniones, ensayos... Dispone de corriente, iluminación, sillas, mesas, escenario y un servicio', 3, 2, 0, 0, 1, 50, 0, 1, 1, 1, 'C/ de la Estación. 29520. Fuente de Piedra.');
...
INSERT INTO `pedido` (`id_pedido`, `id_usuario`, `fecha_pedido`, `precio_pedido`, `num_pedido`) VALUES
	...
	(30, 5, '2026-01-30 10:25:19', 28, '20260130-112519-001'),
	(31, 5, '2026-01-30 10:25:45', 56, '20260130-112545-001'),
	(44, 5, '2026-02-03 17:59:13', 0, '20260203-185913-001');
...
-- Volcando datos para la tabla reservalo2.reservas: ~10 rows (aproximadamente)
DELETE FROM `reservas`;
INSERT INTO `reservas` (`id_reserva`, `id_pista`, `id_usuario`, `id_pedido`, `fecha`, `hora_inicio`, `hora_final`, `fecha_reserva`) VALUES
	(72, 89, 5, 29, '2026-01-30', '12:00:00', '13:00:00', '2026-01-30 10:10:04'),
	(73, 89, 5, 29, '2026-01-30', '13:00:00', '14:00:00', '2026-01-30 10:10:04'),
	(74, 90, 5, 30, '2026-01-30', '12:00:00', '13:00:00', '2026-01-30 10:25:19'),
	(75, 90, 5, 31, '2026-02-03', '08:00:00', '09:00:00', '2026-01-30 10:25:45'),
	(76, 90, 5, 31, '2026-02-03', '09:00:00', '10:00:00', '2026-01-30 10:25:45'),
	(102, 101, 5, 44, '2026-02-04', '00:00:00', '23:59:59', '2026-02-03 17:59:13'),
	(103, 101, 5, 44, '2026-02-05', '00:00:00', '23:59:59', '2026-02-03 17:59:13'),
	(104, 101, 5, 44, '2026-02-06', '00:00:00', '23:59:59', '2026-02-03 17:59:13'),
	(105, 101, 5, 44, '2026-02-07', '00:00:00', '23:59:59', '2026-02-03 17:59:13'),
	(106, 101, 5, 44, '2026-02-08', '00:00:00', '23:59:59', '2026-02-03 17:59:13');
...
-- Volcando datos para la tabla reservalo2.usuarios: ~1 rows (aproximadamente)
DELETE FROM `usuarios`;
INSERT INTO `usuarios` (`id_usuario`, `email`, `password`, `id_rol`, `nombre`, `telf`, `token`, `token_date`) VALUES
	(5, 'danielruizdeveloper@gmail.com', 'f39426ccdb0ce5e981c826977de6f19aaf2da984', 1, 'Daniel', '681671014', '0f816ff0ded29886905e4bc24747835a0242f3f2f3045a8327e18eed59805de6e7596bb02ba34ac8d9d4f07e58516797c966', '2025-09-23 17:54:01');
