...
-- Volcando datos para la tabla reservalo2.franjas_dias: ~28 rows (aproximadamente)
...
-- Volcando datos para la tabla reservalo2.franjas_horarias: ~7 rows (aproximadamente)
...
INSERT INTO `franjas_horarias` (`id_franja_horaria`, `id_tipo_horario`, `id_instalacion`, `hora_inicio_manana`, `hora_fin_manana`, `hora_inicio_tarde`, `hora_fin_tarde`, `franja_unica`) VALUES
	(56, 12, 42, '07:30:00', '14:00:00', '18:00:00', '21:30:00', 0),
	(57, 12, 42, '07:30:00', '14:00:00', '18:00:00', '21:00:00', 0),
	(58, 12, 42, '10:00:00', '13:00:00', '00:00:00', '00:00:00', 0),
	(59, 12, 42, '00:00:00', '00:00:00', '00:00:00', '00:00:00', 0),
	(65, 17, 42, '08:30:00', '14:00:00', '16:00:00', '19:30:00', 1),
	(92, 31, 42, '00:00:00', '00:00:00', '00:00:00', '00:00:00', 1),
	(102, 26, 42, '08:30:00', '14:00:00', '16:30:00', '20:00:00', 1);
...
-- Volcando datos para la tabla reservalo2.tipo_horario: ~4 rows (aproximadamente)
...
INSERT INTO `tipo_horario` (`id_tipo_horario`, `nombre`, `descripcion`, `color`, `fecha_inicio`, `fecha_fin`, `es_especial`, `sin_fecha`) VALUES
	(12, 'Horario de verano', 'Horario para los meses de verano (junio, julio, agosto y septiembre)', '#ff8040', '2025-06-09', '2025-09-15', 0, 0),
	(17, 'Horario de invierno', 'Horario para los meses de invierno (octubre, noviembre, diciembre y enero)', '#0080c0', '2025-09-16', '2026-01-31', 0, 0),
	(26, 'Horario de primavera', 'Horario para los meses de primavera (febrero, marzon, abril y mayo)', '#80ff00', '2025-02-01', '2025-06-09', 0, 0),
	(31, 'Cerrado', 'Las instalaciones con dicho horario permanecerán cerradas los dias señalados', '#ff0000', '2025-01-01', '2026-12-31', 1, 1);
