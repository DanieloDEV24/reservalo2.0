...
-- Volcando datos para la tabla reservalo2.pedido: ~2 rows (aproximadamente)
DELETE FROM `pedido`;
INSERT INTO `pedido` (`id_pedido`, `id_usuario`, `fecha_pedido`, `precio_pedido`, `num_pedido`) VALUES
	(18, 5, '2026-01-29 12:53:05', 56, '20260129-135305-001'),
	(19, 5, '2026-01-29 12:58:21', 28, '20260129-135821-001');
...
-- Volcando datos para la tabla reservalo2.reservas: ~3 rows (aproximadamente)
DELETE FROM `reservas`;
INSERT INTO `reservas` (`id_reserva`, `id_pista`, `id_usuario`, `id_pedido`, `fecha`, `hora_inicio`, `hora_final`, `fecha_reserva`) VALUES
	(60, 89, 5, 18, '2026-01-29', '17:00:00', '18:00:00', '2026-01-29 12:53:05'),
	(61, 89, 5, 18, '2026-01-29', '18:00:00', '19:00:00', '2026-01-29 12:53:05'),
	(62, 89, 5, 19, '2026-01-29', '19:00:00', '20:00:00', '2026-01-29 12:58:21');
