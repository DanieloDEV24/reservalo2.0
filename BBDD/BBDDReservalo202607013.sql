...
-- Volcando datos para la tabla reservalo2.actividad: ~463 rows (aproximadamente)
...
-- Volcando datos para la tabla reservalo2.actividades: ~0 rows (aproximadamente)
...
INSERT INTO `actividades` (`id_actividades`, `nombre`, `fecha_actividad`, `hora_actividad`, `fecha_lanzamiento`, `fecha_limite`, `hora_limite`, `descripcion`, `tiene_aforo`, `aforo`, `tiene_precio`, `precio`, `estado`, `lugar`, `imagen`, `duracion`, `tipo_actividad`, `plazas_ocupadas`) VALUES
	(6, 'Excursión a Nerja', '2026-07-30', '08:30:00', '2026-07-13 17:43:33', '2026-07-20', '15:00:00', 'Disfruta de una jornada en Nerja, uno de los rincones más bonitos de la Costa del Sol. Visitaremos sus famosas cuevas, pasearemos por el Balcón de Europa y tendremos tiempo libre para disfrutar de sus playas y su casco histórico.\r\nIncluye transporte desde Fuente de Piedra y acompañamiento durante toda la excursión.', 0, NULL, 1, 25, 'activa', 'Nerja, Málaga', 'nerja.jpg', '05:00:00', 5, 0);
...
-- Volcando datos para la tabla reservalo2.franjas_dias: ~91 rows (aproximadamente)
...
-- Volcando datos para la tabla reservalo2.franjas_horarias: ~22 rows (aproximadamente)
...
-- Volcando datos para la tabla reservalo2.instalaciones: ~5 rows (aproximadamente)
...
INSERT INTO `pedido` (`id_pedido`, `id_usuario`, `fecha_pedido`, `precio_pedido`, `num_pedido`) VALUES
	(143, 16, '2026-07-06 12:09:23', 84, '20260706-140923-001'),
	(152, 16, '2026-07-06 15:09:24', 28, '20260706-170924-001'),
	(153, 16, '2026-07-06 15:12:15', 28, '20260706-171215-001'),
	(154, 16, '2026-07-06 15:15:03', 28, '20260706-171503-001'),
	(155, 16, '2026-07-06 15:19:36', 56, '20260706-171936-001');
...
-- Volcando datos para la tabla reservalo2.pistas: ~10 rows (aproximadamente)
DELETE FROM `pistas`;
...
-- Volcando datos para la tabla reservalo2.reservas: ~4 rows (aproximadamente)
...
INSERT INTO `reservas` (`id_reserva`, `id_pista`, `id_usuario`, `id_pedido`, `fecha`, `hora_inicio`, `hora_final`, `fecha_reserva`, `pagadas`, `precio_reserva`) VALUES
	(298, 89, 16, 143, '2026-07-06', '08:00:00', '09:00:00', '2026-07-06 12:09:23', 0, 28),
	(299, 89, 16, 143, '2026-07-06', '09:00:00', '10:00:00', '2026-07-06 12:09:23', 0, 28),
	(311, 89, 16, 154, '2026-07-06', '10:00:00', '11:00:00', '2026-07-06 15:15:03', 0, 28),
	(312, 89, 16, 155, '2026-07-03', '08:00:00', '09:00:00', '2026-07-06 15:19:36', 0, 28),
	(313, 89, 16, 155, '2026-07-03', '09:00:00', '10:00:00', '2026-07-06 15:19:36', 0, 28);
...
-- Volcando datos para la tabla reservalo2.reservas_actividades: ~0 rows (aproximadamente)
...
INSERT INTO `usuarios` (`id_usuario`, `email`, `password`, `id_rol`, `nombre`, `telf`, `token`, `token_date`, `usuario_baja`, `fecha_registro`, `ultimo_inicio`) VALUES
	(15, 'admin.instalaciones@fuentedepiedra.com', '1474b04e54fb64ce2557315183de2aa6d2ed8157', 2, 'Administrador', '681671014', NULL, NULL, 0, '2026-02-25', '2026-07-13 15:21:39'),
	(16, 'ruizsotodani2@gmail.com', 'f39426ccdb0ce5e981c826977de6f19aaf2da984', 1, 'Daniel', '681671014', 'd3fec8ba6b72ab874f15321649d02dd36a49cc9b07a2859cdc90f8ff1acc3b2d360d76125fd95d46c1a268c8db5c1f2284b1', '2026-03-25 14:42:19', 1, '2026-02-25', '2026-07-08 10:42:23'),
