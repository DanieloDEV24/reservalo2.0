...
-- Volcando datos para la tabla reservalo2.excepciones_horario: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla reservalo2.franjas_dias: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla reservalo2.franjas_horarias: ~0 rows (aproximadamente)
