...
INSERT INTO `excepciones_horario` (`id_excepciones_horario`, `id_tipo_horario_base`, `id_tipo_horario_excepcion`, `fecha_inicio`, `fecha_fin`) VALUES
	(54, 61, 62, '2025-09-01', '2025-09-01'),
	(55, 61, 62, '2025-09-02', '2025-09-02'),
	(56, 61, 62, '2025-09-03', '2025-09-03'),
	(57, 61, 62, '2025-09-04', '2025-09-04'),
	(58, 61, 62, '2025-09-05', '2025-09-05'),
	(59, 61, 62, '2025-09-06', '2025-09-06'),
	(60, 61, 62, '2025-09-07', '2025-09-07');
...
-- Volcando datos para la tabla reservalo2.franjas_horarias: ~5 rows (aproximadamente)
...
INSERT INTO `franjas_horarias` (`id_franja_horaria`, `id_tipo_horario`, `id_instalacion`, `hora_inicio_manana`, `hora_fin_manana`, `hora_inicio_tarde`, `hora_fin_tarde`, `franja_unica`) VALUES
	(156, 61, 42, '07:30:00', '14:00:00', '18:00:00', '21:00:00', 0),
	(157, 61, 42, '07:30:00', '14:00:00', '18:00:00', '20:00:00', 0),
	(158, 61, 42, '10:00:00', '13:00:00', '00:00:00', '00:00:00', 0),
	(159, 61, 42, '00:00:00', '00:00:00', '00:00:00', '00:00:00', 0),
	(163, 62, 42, '07:30:00', '14:00:00', '00:00:00', '00:00:00', 1);

-- Volcando estructura para tabla reservalo2.horas_pistas
CREATE TABLE IF NOT EXISTS `horas_pistas` (
  ...
  `id_franja_dia` int(11) DEFAULT NULL,
  `hora` time NOT NULL,
  `fecha` date NOT NULL,
  `reservada` tinyint(4) DEFAULT 0,
  PRIMARY KEY (`id_hora_pista`) USING BTREE,
  KEY `id_pista` (`id_pista`),
  KEY `id_tipo_horario` (`id_tipo_horario`),
  KEY `id_franja_dia` (`id_franja_dia`),
  CONSTRAINT `FK_horas_pistas_franjas_dias` FOREIGN KEY (`id_franja_dia`) REFERENCES `franjas_dias` (`id_franja_dia`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `FK_horas_pistas_pistas` FOREIGN KEY (`id_pista`) REFERENCES `pistas` (`id_pista`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `FK_horas_pistas_tipo_horario` FOREIGN KEY (`id_tipo_horario`) REFERENCES `tipo_horario` (`id_tipo_horario`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Volcando datos para la tabla reservalo2.horas_pistas: ~0 rows (aproximadamente)
...
INSERT INTO `pistas` (`id_pista`, `id_instalacion`, `imagen1`, `imagen2`, `imagen3`, `imagen4`, `capacidad_pista`, `precio_pista`, `nombre_pista`, `pista_unica`) VALUES
	...
	(99, 46, 'silo1.jpg', 'silo2.jpg', 'silo3.jpg', 'silo4.jpg', 30, 10, 'pista única Silo', 1);
...
INSERT INTO `tipo_horario` (`id_tipo_horario`, `nombre`, `descripcion`, `color`, `fecha_inicio`, `fecha_fin`, `es_especial`, `sin_fecha`) VALUES
	(61, 'Horario Verano', 'Horario establecido para los meses de verano (junio, julio, agosto y septiembre)', '#ff8040', '2025-06-01', '2025-09-30', 0, 0),
	(62, 'Horario solo mañana verano', 'Horario en el que la instalación estará disponible solo por la mañana en horario de verano', '#c2ca35', '2025-01-01', '2026-12-31', 1, 1);
