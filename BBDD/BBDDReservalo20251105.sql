...
-- Volcando datos para la tabla reservalo2.franjas_dias: ~7 rows (aproximadamente)
...
-- Volcando datos para la tabla reservalo2.franjas_horarias: ~4 rows (aproximadamente)
...
INSERT INTO `franjas_horarias` (`id_franja_horaria`, `id_tipo_horario`, `id_instalacion`, `hora_inicio_manana`, `hora_fin_manana`, `hora_inicio_tarde`, `hora_fin_tarde`, `franja_unica`) VALUES
	(27, 8, 42, '07:30:00', '14:00:00', '18:00:00', '21:00:00', 0),
	(28, 8, 42, '07:30:00', '14:00:00', '18:00:00', '22:00:00', 0),
	(29, 8, 42, '09:00:00', '13:00:00', '00:00:00', '00:00:00', 0),
	(30, 8, 42, '00:00:00', '00:00:00', '00:00:00', '00:00:00', 0);
...
INSERT INTO `tipo_horario` (`id_tipo_horario`, `nombre`, `descripcion`, `color`, `fecha_inicio`, `fecha_fin`) VALUES
	(8, 'Horario de verano', 'Horario para los meses de verano (junio, julio, agosto y semptiembre)', '#ff8040', '2025-06-09', '2025-09-15');
