...
-- Volcando datos para la tabla reservalo2.pedido: ~1 rows (aproximadamente)
DELETE FROM `pedido`;
INSERT INTO `pedido` (`id_pedido`, `id_usuario`, `fecha_pedido`, `precio_pedido`, `num_pedido`) VALUES
	(3, 5, '2026-01-26 16:03:50', 112, '20260126-170350-001');
...
INSERT INTO `reservas` (`id_reserva`, `id_pista`, `id_usuario`, `id_pedido`, `fecha`, `hora_inicio`, `hora_final`, `fecha_reserva`) VALUES
	(26, 89, 5, 3, '2026-01-27', '17:00:00', '18:00:00', '2026-01-26 16:03:50'),
	(27, 89, 5, 3, '2026-01-27', '18:00:00', '19:00:00', '2026-01-26 16:03:50'),
	(28, 89, 5, 3, '2026-01-29', '17:00:00', '18:00:00', '2026-01-26 16:03:50'),
	(29, 89, 5, 3, '2026-01-29', '18:00:00', '19:00:00', '2026-01-26 16:03:50');
