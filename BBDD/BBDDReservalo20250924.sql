...
INSERT INTO `instalaciones` (`id_instalacion`, `nombre`, `descripcion`, `categoria_principal`, `categoria_opcional1`, `precio_completo`, `puede_completo`, `no_pistas`, `capacidad_completo`) VALUES
	(4, 'Campo de fútbol', 'Disfruta de nuestro campo de fútbol de última generación con césped artificial, ideal para entrenamientos, partidos y torneos. Esta instalación versátil permite reservar el campo completo para Fútbol 11, o dividirlo en dos pistas independientes de Fútbol 7', 1, NULL, 33, 1, 0, 11),
	(22, 'Pistas de pádel', 'Pistas de pádel modernas, con superficie de césped sintético azul y cerramiento de cristal y malla metálica. Cuentan con iluminación artificial para partidos nocturnos y están parcialmente cubiertas, ofreciendo comodidad y protección frente a las condiciones climáticas. Ideales para disfrutar del pádel en un entorno deportivo de calidad.', 1, 3, 16, 0, 1, 8),
	(24, 'Pistas de tenis', 'pista de tenis, pista de tenis, pista de tenis, pista de tenis, pista de tenis, pista de tenis', 1, 3, NULL, 0, 0, NULL),
	(26, 'Gym', 'Gym, Gym, Gym, Gym, Gym, Gym, Gym, Gym, Gym, Gym, Gym, Gym, Gym, Gym, Gym, Gym', 1, 3, 40, 0, 1, 20);
...
-- Volcando datos para la tabla reservalo2.pistas: ~5 rows (aproximadamente)
DELETE FROM `pistas`;
INSERT INTO `pistas` (`id_pista`, `id_instalacion`, `imagen1`, `imagen2`, `imagen3`, `imagen4`, `capacidad_pista`, `precio_pista`, `nombre_pista`) VALUES
	(1, 4, 'CampoFutbol4.jpg', 'CampoFutbol3.jpg', 'CampoFutbol2.jpg', 'CampoFutbol1.jpg', 14, 21, 'Pista de fútbol 7. nº1'),
	(2, 4, 'CampoFutbol4.jpg', 'CampoFutbol3.jpg', 'CampoFutbol2.jpg', 'CampoFutbol1.jpg', 14, 21, 'Pista de fútbol 7. nº2'),
	(31, 24, 'pistaTenis4.jpg', 'pistaTenis3.jpg', 'pistaTenis2.jpg', 'pistaTenis1.jpg', 4, 8, 'Pista de tenis nº1'),
	(32, 24, 'pistaTenis4.jpg', 'pistaTenis3.jpg', 'pistaTenis2.jpg', 'pistaTenis1.jpg', 4, 8, 'Pista de tenis nº2'),
	(34, 26, 'Img4.jpg', 'Img3.jpg', 'Img2.jpg', 'Img1.jpg', 20, 40, 'pista única Gym');
