...
<body class="d-flex justify-content-center align-items-center flex-wrap bodyLogin bodyReset">
    ...
    <div class="login">
        ...
        <div class="card-body">
            ...
            <form id="emailPasswordForm" class="mb-6" action="" method="post">
                ...
                <br>
                <div>
                    <button class="btn-primary-personal" type="submit" style="width: 100%;">Enviar correo</button>
                </div>
            </form>
    <br>
