...
<body class="d-flex justify-content-center align-items-center flex-wrap bodyLogin bodyNuevaPass">

    <div id="mensaje4" style="width: 100%; padding: 1%; padding-bottom: 0%; display: flex; justify-content: center;">
    <?php
            if(isset($salida))
            {
                ?>
