    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row gap-5">
          ...
          <div class="col">
            <label for="deporteInstalacion">Deporte:</label>
            <select name="deporteInstalacion" id="deporteInstalacion" class="form-select">
        ...
        <div class="row p-2">
          <label for="descripcion" class="p-0">Descripción</label>
          <textarea name="descripcion" id="descripcionInstalacion" class="form-control"></textarea>
        </div>

        <div class="row mb-2  ">
          <label for="portada">Subir imágenes</label>

          <!-- Botón portada -->
          <div class="col">
            <label class="Documents-btn">
              <input type="file" id="imagenesInstalacion" name="Imagenes" hidden multiple accept="image/*">
