                                        ...
                                        <tbody>
                                          <tr>
                                            <td align="center" class="esd-block-image es-p10t es-p10b" style="font-size:0px">
                                              <a target="_blank">
                                                <img src="https://fvbncbd.stripocdn.email/content/guids/CABINET_54100624d621728c49155116bef5e07d/images/84141618400759579.png" alt="" width="100" style="display:block">
                                              </a>
                                            </td>
                                          </tr>
                                          <tr>
                                            <td align="center" class="esd-block-text es-p10b">
                                              <h1 class="es-m-txt-c" style="font-size:35px;line-height:100%; margin-bottom: 5px !important">
                    ...
                    <td align="center" class="esd-stripe">
                      <table bgcolor="#ffffff" align="center" cellpadding="0" cellspacing="0" width="600" class="es-content-body">
                        <tbody>
                                        ...
                                        <tbody>
                                          <tr>
                                            <td align="center" class="esd-block-text">
                                              <h3 class="es-m-txt-c" style="font-size: 20px;">
                                                danielruizdeveloper@gmail.com
                                              </h3>
                                            </td>
                                          </tr>
                                          <tr> 
                                            <td align="center" class="esd-block-text es-p5t es-p40r es-p40l es-m-p0r es-m-p0l" >
                                              <p style="font-size: 15px; margin: 0 !important">
                                                  <?=$fecha_hoy?>
                                              </p>
                                            </td>
                                          </tr>
                                          <tr>
                                            <td align="center" class="esd-block-text es-p5t es-p15b es-p40r es-p40l es-m-p0r es-m-p0l">
                                              <p style="font-size: 15px;">
                                                Haz clic en el siguiente enlace para recuperar tu contraseña, el enlace caducará en 1h
                                              </p>
                                            </td>
                                          </tr>
                                          <tr>
                                            <td align="center" class="esd-block-button">  
                                              <span class="ci" style="border-style:solid;background:#725AC1;border-width:0px;display:inline-block;border-radius:0px;width:auto; margin-bottom: 10px"><a href="<?=$url?>" class="ch" style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:18px;padding:15px 40px 15px 40px;display:inline-block;background:#725AC1;border-radius:0px;font-family:'Archivo Black', sans-serif;font-weight:bold;font-style:normal;line-height:26.4px;width:auto;text-align:center">CAMBIAR CONTRASEÑA</a></span>
                                            </td>
                                          </tr>
                                        </tbody>
                                      </table>
                          ...
                          <tr>
                            <td align="center" class="esd-structure es-p20t es-p10b es-p20r es-p20l">
                              <!--[if mso]><table width="560" cellpadding="0" cellspacing="0"><tr><td width="280" valign="top"><![endif]-->
                              <table cellpadding="0" cellspacing="0" align="center">
                                <tbody>
                                  <tr>
                                    <td align="center" class="es-m-p0r esd-container-frame es-m-p20b">
                                      <table cellpadding="0" cellspacing="0" width="100%">
                                        <tbody>
                                          <tr>
                                            <td align="center" class="esd-block-text">
                                              <p>
                                                Información: <strong><a href="mailto:info@fuentedepiedra.es">info@fuentedepiedra.es</a></strong>
                                              </p>
                                              <p>
                                                Telf:&nbsp;<strong>666 66 66 66</strong>
                                              </p>
                                              <p>
                                                Dirección:&nbsp;<strong>C/La que sea, 24</strong>
                                              </p>
                                            </td>
                                          </tr>
                                        </tbody>
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td align="center" valign="top" class="es-p40r">
                                                      <a target="_blank" href="">
                                                        <img title="X" src="https://fvbncbd.stripocdn.email/content/assets/img/social-icons/logo-black/x-logo-black.png" alt="X" width="32">
                                                      </a>
                                                    </td>
                                                    <td align="center" valign="top" class="es-p40r">
                                                      <a target="_blank" href="">
                                                        <img title="Instagram" src="https://fvbncbd.stripocdn.email/content/assets/img/social-icons/logo-black/instagram-logo-black.png" alt="Inst" width="32">
                                                      </a>
                                                    </td>
                                                    <td align="center" valign="top">
                                                      <a target="_blank" href="">
                                                        <img title="Youtube" src="https://fvbncbd.stripocdn.email/content/assets/img/social-icons/logo-black/youtube-logo-black.png" alt="Yt" width="32">
                                                      </a>
                                                    </td>
                                                  </tr>
                                                </tbody>
