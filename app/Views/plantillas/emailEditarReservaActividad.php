                              ...
                              <tr>
                                <td align="center" style="padding:0;Margin:0">
                                  <p style="Margin:0;font-family:Lexend, Arial, sans-serif;line-height:18px;color:#32cccc;font-size:12px">
                                    <strong>¡CAMBIOS EN LA RESERVA!</strong>
                                  </p>
                                </td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                <td align="left" style="padding-bottom:30px">
                                  <p style="Margin:0;font-family:Lexend, Arial, sans-serif;line-height:21px;color:#2C2C2C;font-size:14px">
                                    Estimado/a <strong><?= ($rol === 1) ? 'Usuario' : 'Gestor' ?></strong>,
                                  </p>
                                  <p style="Margin:0;font-family:Lexend, Arial, sans-serif;line-height:21px;color:#2C2C2C;font-size:14px"><br></p>
                                  <p style="Margin:0;font-family:Lexend, Arial, sans-serif;line-height:21px;color:#2C2C2C;font-size:14px">
                                    <?= ($rol === 1) ? 'Le informamos de que se ha realizado una modificación en su reserva. Por favor, accede al apartado de "mis reservas" para comprobar los cambios y confirmar que todo está correcto.' : 'Te informamos de que se ha realizado una modificación en una reserva. Por favor, accede al apartado de actividades "inscritos" para comprobar los cambios y confirmar que todo está correcto.' ?>
                                  </p>
                                </td>
                              </tr>
                              <tr>
