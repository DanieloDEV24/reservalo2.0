                              ...
                              <tr>
                                <td align="center" style="padding:20px 0 30px 0">
                                  <h1 style="Margin:0;font-family:Montaga, Arial, serif;font-size:30px;line-height:36px;color:#2C2C2C">
                                    <?php if (isset($datos_reserva['nombre_instalacion'])): ?>
                                      La instalación: <?= esc($datos_reserva['nombre_instalacion']) ?> ya no está disponible
                                    <?php else: ?>
                                      Una instalación ya no está disponible
                                    <?php endif; ?>
                                  </h1>
                                </td>
                              </tr>
                              <tr>
                                <td align="left" style="padding-bottom:30px">
                                  <p style="Margin:0;font-family:Lexend, Arial, sans-serif;line-height:21px;color:#2C2C2C;font-size:14px">
                                    Estimado/a <strong><?= esc($datos_reserva['nombre']) ?></strong>,
                                  </p>
                                  <p style="Margin:0;font-family:Lexend, Arial, sans-serif;line-height:21px;color:#2C2C2C;font-size:14px"><br></p>
                                  <p style="Margin:0;font-family:Lexend, Arial, sans-serif;line-height:21px;color:#2C2C2C;font-size:14px">
                                    Le informamos que la instalación <?= esc($datos_reserva['nombre_instalacion']) ?>, en la cual habías reservado pista, ya no está disponible, por lo que la reserva se ha anulado. Disculpe las molestias.
                                  </p>
                                  <p style="Margin:0;font-family:Lexend, Arial, sans-serif;line-height:21px;color:#2C2C2C;font-size:14px"><br></p>
                                  <p style="Margin:0;font-family:Lexend, Arial, sans-serif;line-height:21px;color:#2C2C2C;font-size:14px">
                                    <strong>Detalles de tu reserva:</strong><br>
                                    📅 Fecha: <?= date('d/m/Y', strtotime($datos_reserva['fecha'])) ?><br>
                                    ⏰ Horas: <strong><?= implode(', ', array_map(fn($h) => substr($h, 0, 5), $datos_reserva['horas'])) ?></strong>
                                  </p>
                                  <p style="Margin:0;font-family:Lexend, Arial, sans-serif;line-height:21px;color:#2C2C2C;font-size:14px"><br></p>
                                </td>
                              </tr>
