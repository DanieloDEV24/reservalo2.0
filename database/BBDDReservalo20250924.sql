...
-- Volcando datos para la tabla reservalo2.instalaciones: ~2 rows (aproximadamente)
DELETE FROM `instalaciones`;
INSERT INTO `instalaciones` (`id_instalacion`, `nombre`, `descripcion`, `categoria_principal`, `categoria_opcional1`, `precio_completo`, `puede_completo`, `no_pistas`, `capacidad_completo`, `estado`) VALUES
	(4, 'Campo de fútbol', 'Disfruta de nuestro campo de fútbol de última generación con césped artificial, ideal para entrenamientos, partidos y torneos. Esta instalación versátil permite reservar el campo completo para Fútbol 11, o dividirlo en dos pistas independientes de Fútbol 7', 1, NULL, 22, 1, 0, 11, 0),
	(26, 'Gym', 'Gym, Gym, Gym, Gym, Gym, Gym, Gym, Gym, Gym, Gym, Gym, Gym, Gym, Gym, Gym, Gym', 1, 3, 40, 0, 1, 20, 0);
...
-- Volcando datos para la tabla reservalo2.pistas: ~4 rows (aproximadamente)
DELETE FROM `pistas`;
INSERT INTO `pistas` (`id_pista`, `id_instalacion`, `imagen1`, `imagen2`, `imagen3`, `imagen4`, `capacidad_pista`, `precio_pista`, `nombre_pista`, `pista_unica`) VALUES
	(1, 4, 'CampoFutbol1.jpg', 'CampoFutbol2.jpg', 'CampoFutbol3.jpg', 'CampoFutbol4.jpg', 14, 22, 'Pista de fútbol 7. nº1', 0),
	(2, 4, 'CampoFutbol4.jpg', 'CampoFutbol3.jpg', 'CampoFutbol2.jpg', 'CampoFutbol1.jpg', 14, 21, 'Pista de fútbol 7. nº2', 0),
	(34, 26, 'Img4.jpg', 'Img3.jpg', 'Img2.jpg', 'Img1.jpg', 20, 40, 'pista única Gym', 1);
